...
//!
//! The example uses blocking APIs and will contact the Firebase Installations REST endpoint.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let InstallationToken { token, expires_at } = installations.get_token(true)?;
