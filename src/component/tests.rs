...
mod tests {
    ...
    use crate::component::{
        Component, ComponentContainer, ComponentError, ComponentType, InstantiationMode,
    };
    ...
    fn eager_component_initializes_immediately() {
        ...
        let provider = container.get_provider("foo");
        let factory: InstanceFactory =
            Arc::new(|_container, _options| Ok(Arc::new(42u32) as DynService));
        let component = Component::new("foo", factory, ComponentType::Public)
    ...
    fn initialize_with_options_stores_options() {
        ...
        let provider = container.get_provider("foo");
        let factory: InstanceFactory =
            Arc::new(|_container, options| Ok(Arc::new(options.options) as DynService));
        let component = Component::new("foo", factory, ComponentType::Public)
